...
const { doHash, doHashValidation, hmacProcess } = require("../services/hashing");
...
exports.verifyVerificationCode = async (req,res) => {
    ...
    try {
        ...
        if(!existingUser.verificationCode || !existingUser.verificationCodeValidation) {
            return res.status(400).json({success:false, message:"something is wrong with the entered code"});
        }
